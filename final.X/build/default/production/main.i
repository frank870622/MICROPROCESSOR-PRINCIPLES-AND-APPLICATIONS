...
# 4 "main.c" 2
# 19 "main.c"
int per_arrp1[30] = { 784, 659, 659, 0, 698, 587, 587, 0, 523, 587, 659, 698, 784, 784, 784, 0,
 784, 659, 659, 0, 698, 587, 587, 0, 523, 659, 784, 784, 659, 0
} ;
int per_arrp2[19] = { 329, 392, 440, 440, 0, 440, 494, 523, 523, 0, 523, 587, 494, 494, 0, 440, 392, 440, 0 };
...
# 184 "main.c"
    ...
    while(1){
        if(strstr(GetString(), "q") != ((void*)0))
            break;
        else if(strstr(GetString(), "s") != ((void*)0)){
            T1CONbits.TMR1ON = 0;
            T3CONbits.TMR3ON = 0;
            ClearBuffer();
        }
        else if(strstr(GetString(), "p") != ((void*)0)){
            T1CONbits.TMR1ON = 1;
            T3CONbits.TMR3ON = 1;
            ClearBuffer();
        }
...
void main(void)
{
    ...
    while(1) {
        ...
        else if(strstr(GetString(), "blink") != ((void*)0)){
            Mode1();
        }


        else if(strstr(GetString(), "breath") != ((void*)0))
            Mode2();
        else if(strstr(GetString(), "music") != ((void*)0))
            Mode3();
    }
    return;
